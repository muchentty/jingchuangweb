<template>
	...
	<view class="all">
		...
		<view class="all-content">
			<view class="content-item" @click="appoint(item)" v-for="item in activity.lists">
...
<script>
	export default {
		...
		methods: {
			Venueitem(){
				uni.navigateTo({
					url:'../Venue-Details-item/Venue-Details-item'
				})
			},
			//立即预约
			appoint(item){
				uni.navigateTo({
					url:'../Appointment-details/Appointment-details?id=' + item.id + '&name=' + this.name
				})
			},
			tapscroll:function(){
				uni.pageScrollTo({
