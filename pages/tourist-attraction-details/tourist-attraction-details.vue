<template>
	<view class="tourist-attraction-details">
		...
		<view class="tourist-attraction-details-content">
			<view class="details-content-item1">
				<view class="details-content-item1-left">
					...
					<br />
					<text class="venue-details-area-item3">{{venue.venue.start_time}}-{{venue.venue.end_time}}</text>
				</view>
				<!-- <view class="venue-details-area-item3">
					<text>{{venue.venue.start_time}}-{{venue.venue.end_time}}</text>
				</view> -->
			</view>
			<view class="details-content-item2" @click="to_map">
				<view class="content-item2-branch">
			...
			<view class="details-content-item3">
				<view class="content-item3-branch" @click="getpone(venue.venue.tel)">
					<view class="item3-branch-left">
						<image src="../../static/phone.png" mode=""></image>
						<text class="item3-branch-left-txt">{{lianxifangshi}}：{{venue.venue.tel}}</text>
					</view>
			...
			<view class="details-content-item4">
				<view class="content-item4-branch">
					<view class="item4-branch-left">
						<text class="item4-branch-left-txt">{{yudingfangshi}}：{{venue.venue.book}}</text>
					</view>
					<view class="item4-branch-right">
						<image src="../../static/ic_ri.png" mode=""></image>
					</view>
				</view>
			</view>
			...
			<!--#ifndef MP-WEIXIN -->
			<view class="tourist-attraction-weather">
				<view class="Weather-title">
					<text>{{dangditianqi}}</text>
				</view>
				<view class="Weather-content">

					<iframe allowtransparency="true" frameborder="0" width="290" height="96" scrolling="no"
						src="http://tianqi.2345.com/plugin/widget/index.htm?s=2&z=1&t=0&v=0&d=2&bd=0&k=&f=&ltf=009944&htf=cc0000&q=0&e=1&a=1&c=54511&w=290&h=96&align=center"></iframe>
			...
			<view class="tourist-attraction-Recommended">
				<view class="Recommended-title">
					{{xiangguantuijian}}
				</view>

				<view class="Recommended-item" v-for="item in venue.lists">
					<view class="Recommended-item-img">
						<image :src="item.cover"></image>
					</view>
					<view class="Recommended-item-txt">
						<text class="Recommended-item-txt1">{{item.name}}</text>
						<br />
					</view>
				</view>
			</view>
	...
	export default {
		...
		methods: {
			...
			initJssdkShare: function(callback) {
				let url = 'pages/tourist-attraction-details/tourist-attraction-details?id=' + this.venue_id
		...
		onShow(e) {
			...
			this.dangditianqi = this.$lang.dangditianqi[uni.getStorageSync('lang')];
			this.jibenjieshao = this.$lang.jibenjieshao[uni.getStorageSync('lang')];
